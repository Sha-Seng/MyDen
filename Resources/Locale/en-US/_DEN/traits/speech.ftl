...
trait-name-OniSoundsReplaceSex = Invert Emote Sex (Oni)
trait-description-OniSoundsReplaceSex = Oni with 'male' sex selected will have a 'female' voice, and vice versa.
